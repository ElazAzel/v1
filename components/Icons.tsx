...
export const WandSparklesIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m22 11-2.5 2.5L22 16" /><path d="m13.5 2.5-2.5 2.5L13.5 8" /><path d="M22 16.5 16 22l-2.5-2.5" /><path d="M8 13.5 2 8l2.5-2.5" /><path d="m16 2-2.5 2.5L11 2" /><path d="m8 22 2.5-2.5L13 22" /><path d="m19 2-4 4-1.5 1.5" /><path d="M5 22 9 18l1.5-1.5" />
  </svg>
);
...
export const TagsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12.586 2.586a2 2 0 0 0-2.828 0L2.172 10.172a2 2 0 0 0 0 2.828l7.071 7.071a2 2 0 0 0 2.828 0l7.586-7.586a2 2 0 0 0 0-2.828L12.586 2.586Z"/><path d="M7 7h.01"/></svg>
);
...
export const TwitterIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.4 3.3 4.4s-1.4 1.4-2.1.8c-1.2 2.3-3.2 4.3-5.2 5.1-2.8.9-5.7.5-8.3-.9-2.6-1.3-4.5-3.5-5.6-6.1.2.2 4.1 2.3 6.9 1.1 1.5-.6 2.5-2.2 3.3-3.8.3-.7-1-1.1-1.1-.9-.5.2-1.2.6-1.5.8-2.1.9-4.2-.2-5.3-2.3-1.4-2.8-2.2-5.4-2.2-5.4s1.2.3 2.5.3c-1.3-1.6-2.9-3.2-5.4-3.2.3 0 2.2 2.1 4.5 3.8 2.3 1.7 5.2 2.6 8.3 2.1 2.8-.5 5.1-2.5 6.3-5.1.2-.6.1-1.2-.1-1.7z"/></svg>
);
...
export const TelegramIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 2 11 13H2l3.4-8.4L22 2zm-20 12 4.4 1.6L20 6.5 7.4 15.9 14 19l3-14.5-19 8.5z"/></svg>
);
...
export const MousePointerClickIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M9 9l5 12 1.8-5.2L21 14l-3.6-8.2" /><path d="m4.4 4.4l7.1 7.1" />
  </svg>
);
...
export const GalleryHorizontalIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
